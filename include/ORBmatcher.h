...
namespace ORB_SLAM3
{
    ...
    public:
        ...
        // Project MapPoints using a Similarity Transformation and search matches.
        // Used in Place Recognition (Loop Closing and Merging) 用于回环和融合
        int SearchByProjection(KeyFrame* pKF, Sophus::Sim3<float> &Scw, const std::vector<MapPoint*> &vpPoints, 
        ...
        // Search matches between MapPoints in a KeyFrame and ORB in a Frame.（在关键帧中的地图点与某一帧中的 ORB 特征之间搜索匹配项。）
